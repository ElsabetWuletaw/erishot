...
import { featuredProjects } from "@/frontend/content/homepage-content";
...
export function FeaturedProjects({
  ...
  const showcaseProjects = projects?.length ? projects : featuredProjects;
  const mainProject = showcaseProjects[0] ?? featuredProjects[0];
  const sideProject = showcaseProjects[1] ?? featuredProjects[1];
  const detailProject = showcaseProjects[2] ?? featuredProjects[2];
